    ...
    <div class="col-md-4">
        <div class="card">
            ...
            <div class="card-body chat-box scrollable" style="height:300px;">
                <ul class="chat-list">
                    <li class="chat-item">
                        <div class="chat-img"><img src="/assets/backend/img/users/1.jpg" alt="user"></div>
                    ...
                    <li class="chat-item">
                        <div class="chat-img"><img src="/assets/backend/img/users/2.jpg" alt="user"></div>
                        <div class="chat-content">
                    ...
                    <li class="chat-item">
                        <div class="chat-img"><img src="/assets/backend/img/users/3.jpg" alt="user"></div>
                        <div class="chat-content">
        ...
        <table id="advanced_table" class="table">
            ...
            <tbody>
                <tr>
                    ...
                    <td><img src="/assets/backend/img/users/1.jpg" class="table-user-thumb" alt=""></td>
                    <td>Tiger Nixon</td>
                ...
                <tr>
                    ...
                    <td><img src="/assets/backend/img/users/2.jpg" class="table-user-thumb" alt=""></td>
                ...
                <tr>
                    ...
                    <td><img src="/assets/backend/img/users/3.jpg" class="table-user-thumb" alt=""></td>
                    <td>Ashton Cox</td>
                ...
                <tr>
                    ...
                    <td><img src="/assets/backend/img/users/4.jpg" class="table-user-thumb" alt=""></td>
                    <td>Cedric Kelly</td>
                ...
                <tr>
                    ...
                    <td><img src="/assets/backend/img/users/5.jpg" class="table-user-thumb" alt=""></td>
                    <td>Airi Satou</td>
                    <td>Accountant</td>
                    <td>Tokyo</td>
                    <td>33</td>
